...
Directory schema version 2 requires a `video_count` for each entry. The optional
`category` field is editorial directory metadata used by the website for browsing
and card labels; neither field is part of an installable collection manifest.
